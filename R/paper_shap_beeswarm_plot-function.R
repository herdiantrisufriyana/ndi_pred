  ...
  function(
    ...
    data <-
      ...
      mutate(
        ...
        , jitter_feature =
          feature_num + runif(freq, -jitter_width, jitter_width)
      )
    ...
    data |>
      ...
      geom_point(
        position = "identity", size = point_size, alpha = transparency
      ) +
      ...
      theme(
        ...
        , legend.title =
          element_text(angle = 90, hjust = 0.5, size = legend_size)
