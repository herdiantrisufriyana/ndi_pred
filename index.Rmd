...
```{r Remove raw_ variables, include=FALSE}
raw_data6 <-
  raw_data5 |>
...
survive_pred_features <-
  c(baseline = "survive_baseline1_rr", stack = "survive_stack_gbm") |>
  obtain_pred_features(
    list(
      survive_baseline1_rr =
        dr_model_desc |>
        filter(outcome == "survive" & type == "baseline" & min_epv == "20")
      , survive_stack_gbm =
        dr_model_desc |>
        filter(outcome == "survive" & type == "residual" & min_epv == "150")
    )
  )
```
...
seq(nrow(filter(model_stacks, outcome == "rop_severe" & type == "residual"))) |>
  ...
  lapply(
    ...
    stack_prediction(
        ...
        , data_dir = "inst/extdata/modeval_data_set/"
        , model_dir = "inst/extdata/model/"
        , prior_model_name = "survive_stack_gbm"
        , indices =  c("id", "t")
      ) |>
      imap(
        ~ .x |>
...
rop_severe_pred_features <-
  ...
  obtain_pred_features(
    list(
      ...
      , rop_severe_stack_rr =
        dr_model_desc |>
        filter(outcome == "rop_severe" & type == "residual" & min_epv == "20")
    )
  )
```
...
bpd_pred_features <-
  ...
  obtain_pred_features(
    list(
      ...
      , bpd_stack_rf =
        dr_model_desc |>
        filter(outcome == "bpd" & type == "residual" & min_epv == "150")
    )
  )
```
...
seq(nrow(filter(model_stacks, outcome == "bpd_moderate_severe" & type == "residual"))) |>
  lapply(
    \(x)
    filter(model_stacks, outcome == "bpd_moderate_severe" & type == "residual") |>
      slice(x)
  ) |>
  lapply(
    \(x)
...
bpd_moderate_severe_pred_features <-
  c(baseline = "survive_baseline1_rr"
    , stack1 = "survive_stack_gbm"
    , stack2 = "bpd_stack_rf"
    , stack3 = "bpd_moderate_severe_stack_dnn"
  ) |>
  obtain_pred_features(
    list(
      survive_baseline1_rr =
...
eugr_hc_pred_features <-
  ...
  obtain_pred_features(
    list(
      ...
      , eugr_hc_baseline2_rr =
        dr_model_desc |>
        filter(outcome == "eugr_hc" & type == "baseline" & min_epv == "20")
      , eugr_hc_stack1_dnn =
        dr_model_desc |>
        filter(outcome == "survive" & type == "residual" & min_epv == "200")
      , eugr_hc_stack_rr =
        dr_model_desc |>
        filter(outcome == "eugr_hc" & type == "residual" & min_epv == "20")
    )
  )
```
...
```{r EUGR-BW prediction - Write baseline 2, include=FALSE}
...
```{r EUGR-BW prediction - Write stack 1, include=FALSE}
seq(nrow(filter(model_stacks, outcome == "survive" & type == "residual"))) |>
  lapply(
    \(x)
    filter(model_stacks, outcome == "survive" & type == "residual") |>
...
seq(nrow(filter(model_stacks, outcome == "eugr_bw" & type == "residual"))) |>
  ...
  lapply(
    ...
    stack_prediction(
        ...
        , data_dir = "inst/extdata/modeval_data_set/"
        , model_dir = "inst/extdata/model/"
        , prior_model_name = "eugr_bw_stack1_rr"
        , indices =  c("id", "t")
      ) |>
      imap(
        ~ .x |>
...
eugr_bw_pred_features <-
  ...
  obtain_pred_features(
    list(
      ...
      , eugr_bw_baseline2_rr =
        dr_model_desc |>
        filter(outcome == "eugr_bw" & type == "baseline" & min_epv == "20")
      , eugr_bw_stack1_rr =
        dr_model_desc |>
        filter(outcome == "survive" & type == "residual" & min_epv == "20")
      , eugr_bw_stack_rr =
        dr_model_desc |>
        filter(outcome == "eugr_bw" & type == "residual" & min_epv == "20")
    )
  )
```
...
hearing_pred_features <-
  ...
  obtain_pred_features(
    list(
      ...
      , hearing_stack_rr =
        dr_model_desc |>
        filter(outcome == "hearing" & type == "residual" & min_epv == "20")
    )
  )
```
...
eval$calibration <-
  ...
  c(list(
      survive_stack_gbm = survive_stack_eval_calibration$survive_stack_gbm
      , rop_severe_stack_rr =
        rop_severe_stack_eval_calibration$rop_severe_stack_rr
      , bpd_stack_rf = bpd_stack_eval_calibration$bpd_stack_rf
      , bpd_moderate_severe_stack_dnn =
        bpd_moderate_severe_stack_eval_calibration$bpd_moderate_severe_stack_dnn
...
eval$discrimination <-
  ...
  c(list(
      survive_stack_gbm = survive_stack_eval_discrimination$survive_stack_gbm
      , rop_severe_stack_rr =
...
th$survive_stack_gbm <-
  eval$threshold$survive_stack_gbm$train |>
  filter(metric == "th") |>
  pull(avg)
```

```{r Evaluate survive stack using test set, include=FALSE}
eval_plot$survive_stack_gbm <-
  lapply(eval, \(x) x$survive_stack_gbm$test) |>
  arrange_eval_plot(
    threshold = th$survive_stack_gbm
...
Figure 8. Severe ROP stacked prediction model evaluation using test set for: (A) calibration plot; (B) decision curve; and (C) ROC curve. Vertical dashed line in panels A and B indicates the chosen threshold. ROC, receiver operating characteristics.
...
Figure 9. BPD stacked prediction model evaluation using test set for: (A) calibration plot; (B) decision curve; and (C) ROC curve. Vertical dashed line in panels A and B indicates the chosen threshold. ROC, receiver operating characteristics.

### Moderate/severe BPD stack

```{r Determine threshold for moderate/severe BPD stack by train set, include=FALSE}
th$bpd_moderate_severe_stack_dnn <-
  eval$threshold$bpd_moderate_severe_stack_dnn$train |>
  filter(metric == "th") |>
  pull(avg)
```

```{r Evaluate moderate/severe BPD stack using test set, include=FALSE}
eval_plot$bpd_moderate_severe_stack_dnn <-
  lapply(eval, \(x) x$bpd_moderate_severe_stack_dnn$test) |>
  arrange_eval_plot(
    threshold = th$bpd_moderate_severe_stack_dnn
    , dc_xmax = 0.6, dc_xby = 0.1
    , dc_ymax = 0.35, dc_yby = 0.05
    , dc_ta_angle = -70
  )
...
Figure 10. Moderate/severe BPD stacked prediction model evaluation using test set for: (A) calibration plot; (B) decision curve; and (C) ROC curve. Vertical dashed line in panels A and B indicates the chosen threshold. ROC, receiver operating characteristics.
...
Figure 11. EUGR-HC baseline prediction model evaluation using test set for: (A) calibration plot; (B) decision curve; and (C) ROC curve. Vertical dashed line in panels A and B indicates the chosen threshold. ROC, receiver operating characteristics.
...
Figure 12. EUGR-HC stacked prediction model evaluation using test set for: (A) calibration plot; (B) decision curve; and (C) ROC curve. Vertical dashed line in panels A and B indicates the chosen threshold. ROC, receiver operating characteristics.
...
Figure 13. EUGR-BW baseline prediction model evaluation using test set for: (A) calibration plot; (B) decision curve; and (C) ROC curve. Vertical dashed line in panels A and B indicates the chosen threshold. ROC, receiver operating characteristics.
...
Figure 14. EUGR-BW stacked prediction model evaluation using test set for: (A) calibration plot; (B) decision curve; and (C) ROC curve. Vertical dashed line in panels A and B indicates the chosen threshold. ROC, receiver operating characteristics.
...
Figure 15. Failed hearing test stacked prediction model evaluation using test set for: (A) calibration plot; (B) decision curve; and (C) ROC curve. Vertical dashed line in panels A and B indicates the chosen threshold. ROC, receiver operating characteristics.
...
cm_summary |>
  kable(
    caption = "Table 18. Predictive performance using test set."
    , format = kable_format
  ) |>
  footnote(
    paste0(
...
cm_selected_time_summary <-
  ...
  select(outcome, timing, TH, everything())
```
...
```{r figure-16, echo=FALSE, fig.height=5, fig.width=7}
demo_trajectories |>
...
Figure 16. A case with ~50% truly-predicted survive and ~20% truly-predicted positives for other outcomes.
...
```{r figure-17, echo=FALSE, fig.height=3, fig.width=7}
demo_trajectories_plot[[1]]
```

Figure 17. Survival trajectories with ~90% truly and 1+ falsely predicted deaths and ~20% falsely predicted survive. Vertical dashed line indicates death age.

```{r figure-18, echo=FALSE, fig.height=5, fig.width=7}
demo_trajectories_plot[[2]]
```

Figure 18. Other outcome trajectories with ~20% truly and ~20% falsely predicted outcomes among ~50% truly predicted survive.
