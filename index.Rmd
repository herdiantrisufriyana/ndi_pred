...
```{r figure-41, fig.height=3.5, fig.width=7}
...
```{r figure-42, fig.height=5, fig.width=7}
mutate(cm_selected_time_summary_val, set = "Validation") |>
  rbind(mutate(cm_selected_time_summary, set = "Test")) |>
...
```{r figure-43, fig.height=5, fig.width=7}
mutate(cm_selected_time_summary_val, set = "Validation") |>
  rbind(mutate(cm_selected_time_summary, set = "Test")) |>
...
```{r figure-44, fig.height=5, fig.width=7}
mutate(cm_selected_time_summary_val, set = "Validation") |>
  rbind(mutate(cm_selected_time_summary, set = "Test")) |>
...
```{r figure-45, fig.height=5, fig.width=7}
mutate(cm_selected_time_summary_val, set = "Validation") |>
  rbind(mutate(cm_selected_time_summary, set = "Test")) |>
...
```{r figure-46, fig.height=5, fig.width=7}
mutate(cm_selected_time_summary_val, set = "Validation") |>
  rbind(mutate(cm_selected_time_summary, set = "Test")) |>
...
```{r figure-47, fig.height=5, fig.width=7}
mutate(cm_selected_time_summary_val, set = "Validation") |>
  rbind(mutate(cm_selected_time_summary, set = "Test")) |>
...
Figure 55. Connection among ventilation predictors. CI, confidence interval; OR, odds ratio.
